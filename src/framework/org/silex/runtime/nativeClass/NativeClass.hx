 ...
 */
#if flash9
typedef NativeInstance =  org.silex.runtime.nativeClass.as3.NativeInstance;

#elseif js
typedef NativeInstance =  org.silex.runtime.nativeClass.js.NativeInstance;

#elseif php
typedef NativeInstance =  org.silex.runtime.nativeClass.php.NativeInstance;
