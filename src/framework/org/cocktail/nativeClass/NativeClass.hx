...
*/
package org.cocktail.nativeClass;

/**
 * Set the right runtime specific NativeInstance at compile-time
 */
#if flash9
typedef NativeInstance =  org.cocktail.nativeClass.as3.NativeInstance;

#elseif js
typedef NativeInstance =  org.cocktail.nativeClass.js.NativeInstance;

#elseif php
typedef NativeInstance =  org.cocktail.nativeClass.php.NativeInstance;
