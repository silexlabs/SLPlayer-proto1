...
slPlayer.core.publication.Publication.doGetBlock = function(block,element,isOwnerMethod) {
	...
	}
	{
		...
		while(_g1 < _g) {
			var i = _g1++;
			var foundBlock = slPlayer.core.publication.Publication.doGetBlock(block.getChildren()[i],element,isOwnerMethod);
			if(foundBlock != null) {
				return foundBlock;
			}
		}
...
slPlayer.core.publication.Publication.prototype.render = function(nativeElement,xmlFileName,xmlString) {
	...
	block.open($closure(this,"firstBlockLoadedSuccessCallback"),$closure(this,"firstBlockLoadedErrorCallback"));
}
slPlayer.core.publication.Publication.prototype.firstBlockLoadedSuccessCallback = function(block) {
	haxe.Log.trace("The first block was opened successfully",{ fileName : "Publication.hx", lineNumber : 312, className : "slPlayer.core.publication.Publication", methodName : "firstBlockLoadedSuccessCallback"});
}
slPlayer.core.publication.Publication.prototype.firstBlockLoadedErrorCallback = function(error) {
...
SimpleUI = function(p) { if( p === $_ ) return; {
	var publication = slPlayer.core.publication.Publication.createPublication(new slPlayer.core.config.Config());
	publication.render(null,"simple_data.xml");
}}
SimpleUI.__name__ = ["SimpleUI"];
SimpleUI.main = function() {
	new SimpleUI();
}
SimpleUI.prototype.onBlockOpened = function(block) {
	haxe.Log.trace("opened",{ fileName : "SimpleUI.hx", lineNumber : 33, className : "SimpleUI", methodName : "onBlockOpened"});
}
SimpleUI.prototype.onBlockOpenError = function(error) {
	haxe.Log.trace(error,{ fileName : "SimpleUI.hx", lineNumber : 38, className : "SimpleUI", methodName : "onBlockOpenError"});
}
SimpleUI.prototype.__class__ = SimpleUI;
...
slPlayer.core.block.Block.prototype.doOpen = function(blockBuilder) {
	if(this._blockData.properties == null) {
		haxe.Log.trace("open loadBlockData",{ fileName : "Block.hx", lineNumber : 337, className : "slPlayer.core.block.Block", methodName : "doOpen"});
...
slPlayer.core.block.Block.prototype.openChildren = function() {
	if(this._children.length > 0) {
		haxe.Log.trace("openChildren " + this._children.length,{ fileName : "Block.hx", lineNumber : 399, className : "slPlayer.core.block.Block", methodName : "openChildren"});
...
if(!slPlayer.blocks) slPlayer.blocks = {}
slPlayer.blocks.Image = function(p) { if( p === $_ ) return; {
	haxe.Timer.delay($closure(this,"initDone"),10);
}}
slPlayer.blocks.Image.__name__ = ["slPlayer","blocks","Image"];
slPlayer.blocks.Image.prototype.initDone = function() {
	if(this.url != "" && this.url != null) {
		var imageDOMElement = new cocktail.domElement.js.ImageDOMElement(cocktail.nativeElement.NativeElementManager.createNativeElement(cocktail.nativeElement.NativeElementTypeValue.image));
		var publication = slPlayer.core.publication.Publication.getPublicationByNativeInstance(this);
		var block = publication.getBlockByNativeInstance(this);
		block.setDOMElement(imageDOMElement);
		cocktail.resource.ResourceLoaderManager.loadImage(this.url,$closure(this,"_imageLoadedSuccess"),$closure(this,"_imageLoadedError"),imageDOMElement);
	}
}
slPlayer.blocks.Image.prototype.url = null;
slPlayer.blocks.Image.prototype.rotation = null;
slPlayer.blocks.Image.prototype.x = null;
slPlayer.blocks.Image.prototype._imageLoadedSuccess = function(imageDOMElement) {
	imageDOMElement.setRotation(this.rotation);
	imageDOMElement.setX(this.x);
	var publication = slPlayer.core.publication.Publication.getPublicationByNativeInstance(this);
	var block = publication.getBlockByNativeInstance(this);
	block.getParent().addToDisplayList(imageDOMElement);
	haxe.Log.trace("_imageLoadedSuccess " + imageDOMElement,{ fileName : "Image.hx", lineNumber : 78, className : "slPlayer.blocks.Image", methodName : "_imageLoadedSuccess"});
}
slPlayer.blocks.Image.prototype._imageLoadedError = function(str) {
	haxe.Log.trace("_imageLoadedError " + str,{ fileName : "Image.hx", lineNumber : 85, className : "slPlayer.blocks.Image", methodName : "_imageLoadedError"});
}
slPlayer.blocks.Image.prototype.__class__ = slPlayer.blocks.Image;
Reflect = function() { }
...
slPlayer.blocks.StandardBlock = function(p) { if( p === $_ ) return; {
	null;
}}
slPlayer.blocks.StandardBlock.__name__ = ["slPlayer","blocks","StandardBlock"];
slPlayer.blocks.StandardBlock.prototype.__class__ = slPlayer.blocks.StandardBlock;
