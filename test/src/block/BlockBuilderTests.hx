...
class BlockBuilderTests 
{
	...
	public function test_deserializeBlockData_1() 
	{
		...
		// parent HGroup
		Assert.equals('slPlayer.blocks.HGroup', block.getBlockData().className);
		...
		// child Image
		Assert.equals('slPlayer.blocks.Image', child.getBlockData().className);
		...
		child = childrenBlock.pop();
		// child Group
		Assert.equals('slPlayer.blocks.Group', child.getBlockData().className);
	...
	/*public function test_createBlockData_1() 
	{
		...
		Assert.equals('slPlayer.blocks.HGroup', blockData.className);
	...
	/*public function test_createBlockData_2() 
	{
		...
		Assert.equals('slPlayer.blocks.Image', blockData.className);
		Assert.equals(606.6, blockData.properties.get('x'));
		Assert.equals(76, blockData.properties.get('width'));
	...
	/*public function test_createBlockData_4() 
	{
		...
		Assert.equals('slPlayer.blocks.Group', blockData.className);
