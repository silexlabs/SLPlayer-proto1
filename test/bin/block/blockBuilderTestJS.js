...
block.BlockBuilderTests = function(p) { if( p === $_ ) return; {
	null;
}}
block.BlockBuilderTests.__name__ = ["block","BlockBuilderTests"];
block.BlockBuilderTests.main = function() {
	var runner = new utest.Runner();
	runner.addCase(new block.BlockBuilderTests());
	utest.ui.Report.create(runner);
	runner.run();
}
block.BlockBuilderTests.prototype.blockSort = function(a,b) {
...
block.BlockBuilderTests.prototype.test_deserializeBlockData_1 = function() {
	var xmlString = "<HGroup>\n\t\t\t<blockData>\n\t\t\t\t<!-- these properties will be set on the controller class -->\n\t\t\t\t<properties>\n\t\t\t\t\t<x type=\"Float\">606.6</x>\n\t\t\t\t\t<y type=\"Float\">199.95</y>\n\t\t\t\t\t<width type=\"Integer\">76</width>\n\t\t\t\t\t<height type=\"Integer\">26</height>\n\t\t\t\t</properties>\n\t\t\t\t<!-- the meta data are not set on any object -->\n\t\t\t\t<!-- the meta data are available for the controller class, the skin or the plugins -->\n\t\t\t\t<metaData>\n\t\t\t\t</metaData>\n\t\t\t</blockData>\n\t\t\t<children>\n\t\t\t\t<!-- this is a block with the controller class set to slPlayer.blocks.Image -->\n\t\t\t\t<Image>\n\t\t\t\t\t<blockData>\n\t\t\t\t\t\t<!-- these properties will be set on the controller class -->\n\t\t\t\t\t\t<properties>\n\t\t\t\t\t\t\t<url>media/test1/im1.jpg</url>\n\t\t\t\t\t\t\t<x type=\"Float\">606.6</x>\n\t\t\t\t\t\t\t<y type=\"Float\">199.95</y>\n\t\t\t\t\t\t\t<width type=\"Integer\">76</width>\n\t\t\t\t\t\t\t<height type=\"Integer\">26</height>\n\t\t\t\t\t\t\t<rotation type=\"Integer\">0</rotation>\n\t\t\t\t\t\t\t<alpha type=\"Integer\">1</alpha>\n\t\t\t\t\t\t\t<textFormat type=\"Array\">\n\t\t\t\t\t\t\t\t<item><![CDATA[font=Arial]]></item>\n\t\t\t\t\t\t\t\t<item><![CDATA[color=4D4D4D]]></item>\n\t\t\t\t\t\t\t\t<item><![CDATA[size=17]]></item>\n\t\t\t\t\t\t\t</textFormat>\n\t\t\t\t\t\t</properties>\n\t\t\t\t\t\t<!-- the meta data are not set on any object -->\n\t\t\t\t\t\t<!-- the meta data are available for the controller class, the skin or the plugins -->\n\t\t\t\t\t\t<metaData>\n\t\t\t\t\t\t</metaData>\n\t\t\t\t\t</blockData>\n\t\t\t\t</Image>\n\t\t\t\t<!-- this is a block with a custom controller class, loaded as part of a library at startup -->\n\t\t\t\t<CustomControllerClass nameSpace=\"com.mycompany.silexcomponents\" isAutoOpen=\"false\">\n\t\t\t\t\t<blockData>\n\t\t\t\t\t\t<properties>\n\t\t\t\t\t\t</properties>\n\t\t\t\t\t\t<metaData>\n\t\t\t\t\t\t</metaData>\n\t\t\t\t\t</blockData>\n\t\t\t\t</CustomControllerClass>\n\t\t\t\t<!-- this block data is in a separate XML file -->\n\t\t\t\t<Group isAutoOpen=\"true\" fileUrl=\"contents/mysite1/layer023.xml\" />\n\t\t\t\t<!-- here is a skinnable block, for which a domElement containing assets is loaded before the controller class is instanciated -->\n\t\t\t\t<SkinnableBlock nameSpace=\"com.mycompany.silexcomponents\" isAutoOpen=\"false\">\n\t\t\t\t\t<blockData>\n\t\t\t\t\t\t<descriptorUID>SkinnableBlockDescriptor</descriptorUID>\n\t\t\t\t\t\t<!-- URLs of the skin, depending on the target runtime -->\n\t\t\t\t\t\t<jsSkinURL>\n\t\t\t\t\t\t\t<url>plugins/mycompanyComponents/js/SkinnableBlock.js</url>\n\t\t\t\t\t\t</jsSkinURL>\n\t\t\t\t\t\t<phpSkinURL>\n\t\t\t\t\t\t\t<url>plugins/mycompanyComponents/php/SkinnableBlock.php</url>\n\t\t\t\t\t\t</phpSkinURL>\n\t\t\t\t\t\t<as3SkinURL>\n\t\t\t\t\t\t\t<url>plugins/mycompanyComponents/as2/SkinnableBlock.swf</url>\n\t\t\t\t\t\t</as3SkinURL>\n\t\t\t\t\t\t<properties>\n\t\t\t\t\t\t</properties>\n\t\t\t\t\t\t<metaData>\n\t\t\t\t\t\t</metaData>\n\t\t\t\t\t</blockData>\n\t\t\t\t</SkinnableBlock>\n\t\t\t</children>\n\t\t</HGroup>";
	var block = new slPlayer.core.block.Block("");
	slPlayer.core.block.BlockBuilder.deserializeBlockData(block,xmlString);
	var childrenBlock = block.getChildren();
	childrenBlock.sort($closure(this,"blockSort"));
	utest.Assert.equals("slPlayer.blocks.HGroup",block.getBlockData().className,null,{ fileName : "BlockBuilderTests.hx", lineNumber : 148, className : "block.BlockBuilderTests", methodName : "test_deserializeBlockData_1"});
	utest.Assert.equals(606.6,block.getBlockData().properties.get("x"),null,{ fileName : "BlockBuilderTests.hx", lineNumber : 149, className : "block.BlockBuilderTests", methodName : "test_deserializeBlockData_1"});
	utest.Assert.equals(76,block.getBlockData().properties.get("width"),null,{ fileName : "BlockBuilderTests.hx", lineNumber : 150, className : "block.BlockBuilderTests", methodName : "test_deserializeBlockData_1"});
	var child;
	child = childrenBlock.pop();
	utest.Assert.equals("slPlayer.blocks.Image",child.getBlockData().className,null,{ fileName : "BlockBuilderTests.hx", lineNumber : 155, className : "block.BlockBuilderTests", methodName : "test_deserializeBlockData_1"});
	utest.Assert.equals(606.6,child.getBlockData().properties.get("x"),null,{ fileName : "BlockBuilderTests.hx", lineNumber : 156, className : "block.BlockBuilderTests", methodName : "test_deserializeBlockData_1"});
	utest.Assert.equals(76,child.getBlockData().properties.get("width"),null,{ fileName : "BlockBuilderTests.hx", lineNumber : 157, className : "block.BlockBuilderTests", methodName : "test_deserializeBlockData_1"});
	utest.Assert.equals(0,child.getBlockData().properties.get("rotation"),null,{ fileName : "BlockBuilderTests.hx", lineNumber : 158, className : "block.BlockBuilderTests", methodName : "test_deserializeBlockData_1"});
	utest.Assert.equals(1,child.getBlockData().properties.get("alpha"),null,{ fileName : "BlockBuilderTests.hx", lineNumber : 159, className : "block.BlockBuilderTests", methodName : "test_deserializeBlockData_1"});
	child = childrenBlock.pop();
	utest.Assert.equals("slPlayer.blocks.Group",child.getBlockData().className,null,{ fileName : "BlockBuilderTests.hx", lineNumber : 163, className : "block.BlockBuilderTests", methodName : "test_deserializeBlockData_1"});
	utest.Assert.equals(true,child.getIsAutoOpen(),null,{ fileName : "BlockBuilderTests.hx", lineNumber : 164, className : "block.BlockBuilderTests", methodName : "test_deserializeBlockData_1"});
	utest.Assert.equals("contents/mysite1/layer023.xml",child.getFileUrl(),null,{ fileName : "BlockBuilderTests.hx", lineNumber : 165, className : "block.BlockBuilderTests", methodName : "test_deserializeBlockData_1"});
	child = childrenBlock.pop();
	utest.Assert.equals("com.mycompany.silexcomponents.SkinnableBlock",child.getBlockData().className,null,{ fileName : "BlockBuilderTests.hx", lineNumber : 169, className : "block.BlockBuilderTests", methodName : "test_deserializeBlockData_1"});
	utest.Assert.equals(false,child.getIsAutoOpen(),null,{ fileName : "BlockBuilderTests.hx", lineNumber : 170, className : "block.BlockBuilderTests", methodName : "test_deserializeBlockData_1"});
	utest.Assert.equals("SkinnableBlockDescriptor",child.getBlockData().descriptorUID,null,{ fileName : "BlockBuilderTests.hx", lineNumber : 171, className : "block.BlockBuilderTests", methodName : "test_deserializeBlockData_1"});
	utest.Assert.equals("plugins/mycompanyComponents/js/SkinnableBlock.js",child.getBlockData().jsSkinURL,null,{ fileName : "BlockBuilderTests.hx", lineNumber : 172, className : "block.BlockBuilderTests", methodName : "test_deserializeBlockData_1"});
	utest.Assert.equals("plugins/mycompanyComponents/php/SkinnableBlock.php",child.getBlockData().phpSkinURL,null,{ fileName : "BlockBuilderTests.hx", lineNumber : 173, className : "block.BlockBuilderTests", methodName : "test_deserializeBlockData_1"});
	utest.Assert.equals("plugins/mycompanyComponents/as2/SkinnableBlock.swf",child.getBlockData().as3SkinURL,null,{ fileName : "BlockBuilderTests.hx", lineNumber : 174, className : "block.BlockBuilderTests", methodName : "test_deserializeBlockData_1"});
	child = childrenBlock.pop();
	utest.Assert.equals("com.mycompany.silexcomponents.CustomControllerClass",child.getBlockData().className,null,{ fileName : "BlockBuilderTests.hx", lineNumber : 178, className : "block.BlockBuilderTests", methodName : "test_deserializeBlockData_1"});
	utest.Assert.equals(false,child.getIsAutoOpen(),null,{ fileName : "BlockBuilderTests.hx", lineNumber : 179, className : "block.BlockBuilderTests", methodName : "test_deserializeBlockData_1"});
}
block.BlockBuilderTests.prototype.testSetBlockAttribute = function() {
	...
	var blockBuilder = new slPlayer.core.block.BlockBuilder(parentBlock);
	blockBuilder.createClassInstance();
	blockBuilder.setBlockAttributes();
	utest.Assert.equals(parentBlock.getClassInstance().getField("testStringProperty"),"testStringValue",null,{ fileName : "BlockBuilderTests.hx", lineNumber : 502, className : "block.BlockBuilderTests", methodName : "testSetBlockAttribute"});
	utest.Assert.equals(parentBlock.getClassInstance().getField("testBoolProperty"),true,null,{ fileName : "BlockBuilderTests.hx", lineNumber : 504, className : "block.BlockBuilderTests", methodName : "testSetBlockAttribute"});
	utest.Assert.equals(parentBlock.getClassInstance().getField("testIntProperty"),1,null,{ fileName : "BlockBuilderTests.hx", lineNumber : 506, className : "block.BlockBuilderTests", methodName : "testSetBlockAttribute"});
	utest.Assert.equals(parentBlock.getClassInstance().getField("testFloatProperty"),1.2,null,{ fileName : "BlockBuilderTests.hx", lineNumber : 508, className : "block.BlockBuilderTests", methodName : "testSetBlockAttribute"});
	utest.Assert.equals(parentBlock.getClassInstance().getField("testArrayProperty")[0],1,null,{ fileName : "BlockBuilderTests.hx", lineNumber : 510, className : "block.BlockBuilderTests", methodName : "testSetBlockAttribute"});
	utest.Assert.equals(parentBlock.getClassInstance().getField("testArrayProperty")[1],"value",null,{ fileName : "BlockBuilderTests.hx", lineNumber : 511, className : "block.BlockBuilderTests", methodName : "testSetBlockAttribute"});
}
block.BlockBuilderTests.prototype.__class__ = block.BlockBuilderTests;
