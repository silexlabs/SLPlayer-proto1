...
org.silex.runtime.domobject.js.DOMObject.prototype.setIsVisible = function(value) {
	if(value == true) this._referenceToNativeDOM.style.visibility = "visible"; else this._referenceToNativeDOM.style.visibility = "hidden";
	return value;
}
org.silex.runtime.domobject.js.DOMObject.prototype.getIsVisible = function() {
	if(this._referenceToNativeDOM.style.visibility == "visible") return true; else return false;
}
...
org.silex_unit_tests.core.block.BlockTests = function(p) {
}
org.silex_unit_tests.core.block.BlockTests.__name__ = ["org","silex_unit_tests","core","block","BlockTests"];
org.silex_unit_tests.core.block.BlockTests.main = function() {
	var runner = new utest.Runner();
	runner.addCase(new org.silex_unit_tests.core.block.BlockTests());
	utest.ui.Report.create(runner);
	runner.run();
}
org.silex_unit_tests.core.block.BlockTests.prototype.testAddRemoveChild = function() {
	var parentBlock = new org.silex.core.block.Block("");
	var childBlock = new org.silex.core.block.Block("");
	parentBlock.addChild(childBlock);
	utest.Assert.equals(parentBlock.getChildren()[0],childBlock,null,{ fileName : "BlockTests.hx", lineNumber : 55, className : "org.silex_unit_tests.core.block.BlockTests", methodName : "testAddRemoveChild"});
	parentBlock.removeChild(childBlock);
	utest.Assert.equals(parentBlock.getChildren().length,0,null,{ fileName : "BlockTests.hx", lineNumber : 61, className : "org.silex_unit_tests.core.block.BlockTests", methodName : "testAddRemoveChild"});
}
org.silex_unit_tests.core.block.BlockTests.prototype.testAddRemoveFromDisplayList = function() {
	var refToDOM = js.Lib.document.body;
	var parentBlock = new org.silex.core.block.Block("");
	var parentBlockDOMObject = new org.silex.runtime.domobject.js.DOMObject(refToDOM);
	parentBlock.setDOMObject(parentBlockDOMObject);
	var childRefToDOM = js.Lib.document.createElement("div");
	var childBlock = new org.silex.core.block.Block("");
	var childBlockDOMObject = new org.silex.runtime.domobject.js.DOMObject(childRefToDOM);
	childBlock.setDOMObject(childBlockDOMObject);
	parentBlock.addToDisplayList(childBlock.getDOMObject());
	utest.Assert.equals(parentBlock.getDOMObject().getChildren()[0],childBlock.getDOMObject(),null,{ fileName : "BlockTests.hx", lineNumber : 96, className : "org.silex_unit_tests.core.block.BlockTests", methodName : "testAddRemoveFromDisplayList"});
	parentBlock.removeFromDisplayList(childBlock.getDOMObject());
	utest.Assert.equals(parentBlock.getDOMObject().getChildren().length,0,null,{ fileName : "BlockTests.hx", lineNumber : 102, className : "org.silex_unit_tests.core.block.BlockTests", methodName : "testAddRemoveFromDisplayList"});
	var nonVisualBlock = new org.silex.core.block.Block("");
	parentBlock.addChild(nonVisualBlock);
	nonVisualBlock.addToDisplayList(childBlock.getDOMObject());
	utest.Assert.equals(parentBlock.getDOMObject().getChildren()[0],childBlock.getDOMObject(),null,{ fileName : "BlockTests.hx", lineNumber : 117, className : "org.silex_unit_tests.core.block.BlockTests", methodName : "testAddRemoveFromDisplayList"});
	nonVisualBlock.removeFromDisplayList(childBlock.getDOMObject());
	utest.Assert.equals(parentBlock.getDOMObject().getChildren().length,0,null,{ fileName : "BlockTests.hx", lineNumber : 123, className : "org.silex_unit_tests.core.block.BlockTests", methodName : "testAddRemoveFromDisplayList"});
}
org.silex_unit_tests.core.block.BlockTests.prototype.testOpenCloseBlock = function() {
	var parentBlock = new org.silex.core.block.Block("");
	var parentBlockBlockData = { className : "org.silex_unit_tests.core.block.TestNativeClass", descriptorUID : null, jsSkinURL : null, as3SkinURL : null, phpSkinURL : null, properties : new Hash(), metaData : new Hash()};
	...
	utest.Assert.same(parentBlock.getState(),org.silex.core.block.BlockStateValue.closed,null,null,{ fileName : "BlockTests.hx", lineNumber : 154, className : "org.silex_unit_tests.core.block.BlockTests", methodName : "testOpenCloseBlock"});
	parentBlock.open(successCallback,$closure(this,"onBlockOpenError"));
}
org.silex_unit_tests.core.block.BlockTests.prototype.onBlockOpenSuccess = function(openedBlock) {
	utest.Assert.same(openedBlock.getState(),org.silex.core.block.BlockStateValue.opened,null,null,{ fileName : "BlockTests.hx", lineNumber : 166, className : "org.silex_unit_tests.core.block.BlockTests", methodName : "onBlockOpenSuccess"});
	openedBlock.close();
	utest.Assert.same(openedBlock.getState(),org.silex.core.block.BlockStateValue.closed,null,null,{ fileName : "BlockTests.hx", lineNumber : 170, className : "org.silex_unit_tests.core.block.BlockTests", methodName : "onBlockOpenSuccess"});
}
org.silex_unit_tests.core.block.BlockTests.prototype.onBlockOpenError = function(error) {
}
org.silex_unit_tests.core.block.BlockTests.prototype.testOpenCloseBlock2 = function() {
	var parentBlock = new org.silex.core.block.Block("");
...
org.silex_unit_tests.core.block.BlockTests.prototype.onBlockOpenSuccess2 = function(openedBlock) {
	utest.Assert.equals(openedBlock.getNativeClassInstance().getField("testStringProperty"),"testStringValue",null,{ fileName : "BlockTests.hx", lineNumber : 226, className : "org.silex_unit_tests.core.block.BlockTests", methodName : "onBlockOpenSuccess2"});
	utest.Assert.equals(openedBlock.getNativeClassInstance().getField("testBoolProperty"),true,null,{ fileName : "BlockTests.hx", lineNumber : 228, className : "org.silex_unit_tests.core.block.BlockTests", methodName : "onBlockOpenSuccess2"});
	utest.Assert.equals(openedBlock.getNativeClassInstance().getField("testIntProperty"),1,null,{ fileName : "BlockTests.hx", lineNumber : 230, className : "org.silex_unit_tests.core.block.BlockTests", methodName : "onBlockOpenSuccess2"});
	utest.Assert.equals(openedBlock.getNativeClassInstance().getField("testFloatProperty"),1.2,null,{ fileName : "BlockTests.hx", lineNumber : 232, className : "org.silex_unit_tests.core.block.BlockTests", methodName : "onBlockOpenSuccess2"});
	utest.Assert.equals(openedBlock.getNativeClassInstance().getField("testArrayProperty")[0],1,null,{ fileName : "BlockTests.hx", lineNumber : 234, className : "org.silex_unit_tests.core.block.BlockTests", methodName : "onBlockOpenSuccess2"});
	utest.Assert.equals(openedBlock.getNativeClassInstance().getField("testArrayProperty")[1],"value",null,{ fileName : "BlockTests.hx", lineNumber : 235, className : "org.silex_unit_tests.core.block.BlockTests", methodName : "onBlockOpenSuccess2"});
}
org.silex_unit_tests.core.block.BlockTests.prototype.onBlockOpenError2 = function(error) {
}
org.silex_unit_tests.core.block.BlockTests.prototype.testOpenCloseBlock3 = function() {
	var parentBlock = new org.silex.core.block.Block("");
	var parentBlockBlockData = { className : "org.silex_unit_tests.core.block.TestNativeClass", descriptorUID : null, jsSkinURL : null, as3SkinURL : null, phpSkinURL : null, properties : new Hash(), metaData : new Hash()};
	parentBlock.setBlockData(parentBlockBlockData);
	var refToDOM = js.Lib.document.body;
	var parentDOMObject = new org.silex.runtime.domobject.js.DOMObject(refToDOM);
	var childBlock = new org.silex.core.block.Block("");
	var childBlockData = { className : "org.silex_unit_tests.core.block.TestNativeClass", descriptorUID : null, jsSkinURL : null, as3SkinURL : null, phpSkinURL : null, properties : new Hash(), metaData : new Hash()};
...
org.silex_unit_tests.core.block.BlockTests.prototype.onBlockOpenSuccess3 = function(openedBlock) {
	utest.Assert.equals(openedBlock.getChildren()[0].getState(),org.silex.core.block.BlockStateValue.opened,null,{ fileName : "BlockTests.hx", lineNumber : 305, className : "org.silex_unit_tests.core.block.BlockTests", methodName : "onBlockOpenSuccess3"});
	openedBlock.close();
	utest.Assert.equals(openedBlock.getChildren()[0].getState(),org.silex.core.block.BlockStateValue.closed,null,{ fileName : "BlockTests.hx", lineNumber : 310, className : "org.silex_unit_tests.core.block.BlockTests", methodName : "onBlockOpenSuccess3"});
}
org.silex_unit_tests.core.block.BlockTests.prototype.onBlockOpenError3 = function(error) {
}
org.silex_unit_tests.core.block.BlockTests.prototype.__class__ = org.silex_unit_tests.core.block.BlockTests;
...
org.silex.core.block.Block.prototype.domObject = null;
org.silex.core.block.Block.prototype._nativeClassInstance = null;
org.silex.core.block.Block.prototype.nativeClassInstance = null;
org.silex.core.block.Block.prototype._fileUrl = null;
org.silex.core.block.Block.prototype.fileUrl = null;
org.silex.core.block.Block.prototype._state = null;
org.silex.core.block.Block.prototype.state = null;
org.silex.core.block.Block.prototype._children = null;
org.silex.core.block.Block.prototype.children = null;
org.silex.core.block.Block.prototype._parent = null;
org.silex.core.block.Block.prototype.parent = null;
org.silex.core.block.Block.prototype._isTransversal = null;
org.silex.core.block.Block.prototype.isTransversal = null;
org.silex.core.block.Block.prototype._isAutoOpen = null;
org.silex.core.block.Block.prototype.isAutoOpen = null;
...
org.silex.core.block.Block.prototype.setFileUrl = function(value) {
	this._fileUrl = value;
	return this._fileUrl;
}
...
org.silex.runtime.resource.ResourceLoader = function(p) {
}
...
org.silex.runtime.resource.js.ImageLoader = function(p) {
	if( p === $_ ) return;
...
org.silex.runtime.resource.js.StringLoader = function(p) {
	if( p === $_ ) return;
	org.silex.runtime.resource.ResourceLoader.call(this);
}
...
org.silex.runtime.domobject.Matrix.prototype.getFlip = function() {
	var scaleX = this.getScaleX();
	var scaleXSign = 0;
...
org.silex.runtime.domobject.Matrix.prototype.getSkewX = function() {
	return this._matrixData.c;
}
org.silex.runtime.domobject.Matrix.prototype.getSkewY = function() {
...
org.silex.runtime.resource.js.AnimationLoader = function(p) {
	if( p === $_ ) return;
	org.silex.runtime.resource.ResourceLoader.call(this);
}
...
org.silex.core.block.BlockBuilder.prototype.loadBlockData = function(successCallback,errorCallback) {
	...
	org.silex.runtime.resource.ResourceLoaderManager.loadString(this._block.getFileUrl(),$closure(this,"onBlockDataLoaded"),$closure(this,"onBlockDataLoadError"));
}
...
org.silex.core.block.BlockBuilder.prototype.loadDOMObject = function(skinUrl,successCallback,errorCallback) {
	...
	org.silex.runtime.resource.ResourceLoaderManager.loadContainer(skinUrl,$closure(this,"onDOMObjectLoaded"),$closure(this,"onDOMObjectLoadError"));
}
...
org.silex.runtime.resource.js.ContainerLoader = function(p) {
	if( p === $_ ) return;
	org.silex.runtime.resource.ResourceLoader.call(this);
}
...
org.silex.runtime.resource.ResourceLoaderManager = function(p) {
}
...
org.silex.runtime.resource.ResourceLoaderManager.addResourceData = function(resourceData) {
	if(org.silex.runtime.resource.ResourceLoaderManager._resourceDataArray == null) org.silex.runtime.resource.ResourceLoaderManager._resourceDataArray = new Array();
	org.silex.runtime.resource.ResourceLoaderManager._resourceDataArray.push(resourceData);
	if(org.silex.runtime.resource.ResourceLoaderManager._isLoading == false) org.silex.runtime.resource.ResourceLoaderManager.loadNextResource();
}
org.silex.runtime.resource.ResourceLoaderManager.loadNextResource = function() {
	if(org.silex.runtime.resource.ResourceLoaderManager._resourceDataArray.length == 0) org.silex.runtime.resource.ResourceLoaderManager._isLoading = false; else {
		...
		resourceLoader.load(resourceDataToLoad.url,org.silex.runtime.resource.ResourceLoaderManager.onLoadComplete,org.silex.runtime.resource.ResourceLoaderManager.onLoadError,resourceDataToLoad.allowCache);
	}
}
...
org.silex.runtime.nativeClass.NativeInstanceBase.prototype.getField = function(fieldName) {
	...
	if(this.isFunction(fieldGetterName)) return Reflect.field(this._refToNativeClassInstance,fieldGetterName).apply(this._refToNativeClassInstance,[]); else return Reflect.field(this._refToNativeClassInstance,fieldName);
}
org.silex.runtime.nativeClass.NativeInstanceBase.prototype.setField = function(fieldName,fieldValue) {
	...
	if(this.isFunction(fieldSetterName)) Reflect.field(this._refToNativeClassInstance,fieldSetterName).apply(this._refToNativeClassInstance,[fieldValue]); else this._refToNativeClassInstance[fieldName] = fieldValue;
}
org.silex.runtime.nativeClass.NativeInstanceBase.prototype.isFunction = function(functionName) {
	return Reflect.isFunction(Reflect.field(this._refToNativeClassInstance,functionName));
}
...
org.silex.runtime.resource.js.LibraryLoader = function(p) {
	if( p === $_ ) return;
	org.silex.runtime.resource.ResourceLoader.call(this);
}
...
org.silex.runtime.resource.js.TextLoader = function(p) {
	if( p === $_ ) return;
	org.silex.runtime.resource.ResourceLoader.call(this);
}
...
org.silex.runtime.nativeClass.NativeInstanceBase.SETTER_PREFIX = "set";
org.silex.runtime.nativeClass.NativeInstanceBase.GETTER_PREFIX = "get";
js.Lib.onerror = null;
org.silex_unit_tests.core.block.BlockTests.main()