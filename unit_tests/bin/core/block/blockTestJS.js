...
org.silex_unit_tests.core.block.BlockTests.prototype.testOpenCloseBlock = function() {
	var parentBlock = new org.silex.core.block.Block("");
	var parentBlockBlockData = { className : "org.silex_unit_tests.core.block.TestNativeClass", descriptorUID : null, isAutoOpen : false, isTransversal : false, hasSeparateFile : false, fileUrl : null, domRoot : null, jsURL : null, as3URL : null, phpURL : null, properties : new Hash(), metaData : new Hash()};
	...
	utest.Assert.same(parentBlock.getState(),org.silex.core.block.BlockStateValue.closed,null,null,{ fileName : "BlockTests.hx", lineNumber : 159, className : "org.silex_unit_tests.core.block.BlockTests", methodName : "testOpenCloseBlock"});
...
org.silex_unit_tests.core.block.BlockTests.prototype.onBlockOpenSuccess = function(openedBlock) {
	utest.Assert.same(openedBlock.getState(),org.silex.core.block.BlockStateValue.opened,null,null,{ fileName : "BlockTests.hx", lineNumber : 171, className : "org.silex_unit_tests.core.block.BlockTests", methodName : "onBlockOpenSuccess"});
	openedBlock.close();
	utest.Assert.same(openedBlock.getState(),org.silex.core.block.BlockStateValue.closed,null,null,{ fileName : "BlockTests.hx", lineNumber : 175, className : "org.silex_unit_tests.core.block.BlockTests", methodName : "onBlockOpenSuccess"});
}
...
org.silex_unit_tests.core.block.BlockTests.prototype.onBlockOpenSuccess2 = function(openedBlock) {
	utest.Assert.equals(openedBlock.getNativeClassInstance().getField("testStringProperty"),"testStringValue",null,{ fileName : "BlockTests.hx", lineNumber : 235, className : "org.silex_unit_tests.core.block.BlockTests", methodName : "onBlockOpenSuccess2"});
	utest.Assert.equals(openedBlock.getNativeClassInstance().getField("testBoolProperty"),true,null,{ fileName : "BlockTests.hx", lineNumber : 237, className : "org.silex_unit_tests.core.block.BlockTests", methodName : "onBlockOpenSuccess2"});
	utest.Assert.equals(openedBlock.getNativeClassInstance().getField("testIntProperty"),1,null,{ fileName : "BlockTests.hx", lineNumber : 239, className : "org.silex_unit_tests.core.block.BlockTests", methodName : "onBlockOpenSuccess2"});
	utest.Assert.equals(openedBlock.getNativeClassInstance().getField("testFloatProperty"),1.2,null,{ fileName : "BlockTests.hx", lineNumber : 241, className : "org.silex_unit_tests.core.block.BlockTests", methodName : "onBlockOpenSuccess2"});
	utest.Assert.equals(openedBlock.getNativeClassInstance().getField("testArrayProperty")[0],1,null,{ fileName : "BlockTests.hx", lineNumber : 243, className : "org.silex_unit_tests.core.block.BlockTests", methodName : "onBlockOpenSuccess2"});
	utest.Assert.equals(openedBlock.getNativeClassInstance().getField("testArrayProperty")[1],"value",null,{ fileName : "BlockTests.hx", lineNumber : 244, className : "org.silex_unit_tests.core.block.BlockTests", methodName : "onBlockOpenSuccess2"});
}
...
org.silex_unit_tests.core.block.BlockTests.prototype.testOpenCloseBlock3 = function() {
	...
	var childBlock = new org.silex.core.block.Block("");
	var childBlockData = { className : "org.silex_unit_tests.core.block.TestNativeClass", descriptorUID : null, isAutoOpen : true, isTransversal : false, hasSeparateFile : false, fileUrl : null, domRoot : null, jsURL : null, as3URL : null, phpURL : null, properties : new Hash(), metaData : new Hash()};
...
org.silex_unit_tests.core.block.BlockTests.prototype.onBlockOpenSuccess3 = function(openedBlock) {
	utest.Assert.equals(openedBlock.getChildren()[0].getState(),org.silex.core.block.BlockStateValue.opened,null,{ fileName : "BlockTests.hx", lineNumber : 324, className : "org.silex_unit_tests.core.block.BlockTests", methodName : "onBlockOpenSuccess3"});
	openedBlock.close();
	utest.Assert.equals(openedBlock.getChildren()[0].getState(),org.silex.core.block.BlockStateValue.closed,null,{ fileName : "BlockTests.hx", lineNumber : 329, className : "org.silex_unit_tests.core.block.BlockTests", methodName : "onBlockOpenSuccess3"});
}
