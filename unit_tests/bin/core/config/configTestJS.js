...
if(!org.silex_unit_tests.core.config) org.silex_unit_tests.core.config = {}
org.silex_unit_tests.core.config.ConfigTests = function(p) { if( p === $_ ) return; {
	null;
}}
org.silex_unit_tests.core.config.ConfigTests.__name__ = ["org","silex_unit_tests","core","config","ConfigTests"];
org.silex_unit_tests.core.config.ConfigTests.main = function() {
	var runner = new utest.Runner();
	runner.addCase(new org.silex_unit_tests.core.config.ConfigTests());
	utest.ui.Report.create(runner);
	runner.run();
}
org.silex_unit_tests.core.config.ConfigTests.prototype.testConfig = function() {
	var configDataTest = org.silex.core.config.Config.getConfigData();
	var configObjectTest;
	configObjectTest = { };
	org.silex.core.config.Config.addConfigValues(configObjectTest);
	utest.Assert.same(org.silex.core.config.Config.getConfigData(),configDataTest,null,null,{ fileName : "ConfigTests.hx", lineNumber : 49, className : "org.silex_unit_tests.core.config.ConfigTests", methodName : "testConfig"});
	configObjectTest = { publicationId : "testPublicationId", scaleMode : "showAll"};
	org.silex.core.config.Config.addConfigValues(configObjectTest);
	utest.Assert["is"](org.silex.core.config.Config.getConfigData().scaleMode,org.silex.core.config.ScaleModeValue,null,{ fileName : "ConfigTests.hx", lineNumber : 60, className : "org.silex_unit_tests.core.config.ConfigTests", methodName : "testConfig"});
	configObjectTest = { scaleMode : "showAll"};
	configDataTest = org.silex.core.config.Config.duplicateConfigData(org.silex.core.config.Config.getConfigData());
	configDataTest.scaleMode = org.silex.core.config.ScaleModeValue.showAll;
	org.silex.core.config.Config.addConfigValues(configObjectTest);
	utest.Assert.same(org.silex.core.config.Config.getConfigData(),configDataTest,null,null,{ fileName : "ConfigTests.hx", lineNumber : 73, className : "org.silex_unit_tests.core.config.ConfigTests", methodName : "testConfig"});
	configObjectTest = { scaleMode : "showAll", unknownPropertyName : "unknownPropertyValue"};
	configDataTest = org.silex.core.config.Config.getConfigData();
	configDataTest.scaleMode = org.silex.core.config.ScaleModeValue.showAll;
	org.silex.core.config.Config.addConfigValues(configObjectTest);
	utest.Assert.same(org.silex.core.config.Config.getConfigData(),configDataTest,null,null,{ fileName : "ConfigTests.hx", lineNumber : 86, className : "org.silex_unit_tests.core.config.ConfigTests", methodName : "testConfig"});
}
org.silex_unit_tests.core.config.ConfigTests.prototype.__class__ = org.silex_unit_tests.core.config.ConfigTests;
...
org.silex_unit_tests.core.config.ConfigTests.main()