...
org.silex_unit_tests.core.XmlUtilsTests = function(p) { if( p === $_ ) return; {
	$s.push("org.silex_unit_tests.core.XmlUtilsTests::new");
	var $spos = $s.length;
	null;
	$s.pop();
}}
org.silex_unit_tests.core.XmlUtilsTests.__name__ = ["org","silex_unit_tests","core","XmlUtilsTests"];
org.silex_unit_tests.core.XmlUtilsTests.main = function() {
	$s.push("org.silex_unit_tests.core.XmlUtilsTests::main");
	var $spos = $s.length;
	var runner = new utest.Runner();
	runner.addCase(new org.silex_unit_tests.core.XmlUtilsTests());
	utest.ui.Report.create(runner);
	runner.run();
	$s.pop();
}
org.silex_unit_tests.core.XmlUtilsTests.prototype.test_cleanUpXml_1 = function() {
	$s.push("org.silex_unit_tests.core.XmlUtilsTests::test_cleanUpXml_1");
	var $spos = $s.length;
	var inputString = "<rss a=\"b\">\r\n    <channel>\r\n        <title>Mon site</title>\r\n        <description>Ceci est un exemple de flux RSS 2.0</description>\r\n        <lastBuildDate>Sat, 07 Sep 2002 00:00:01 GMT</lastBuildDate>\r\n        <link>http://www.example.org</link>\r\n        <item>\r\n\t\t\t<title><![CDATA[Actualité N°1]]></title>\r\n            <description><![CDATA[Ceci est ma première actualité]]></description>\r\n            <pubDate>Sat, 07 Sep 2002 00:00:01 GMT</pubDate>\r\n            <link>http://www.example.org/actu1</link>\r\n        </item>\r\n        <item>\r\n            <title><![CDATA[Actualité N°2]]></title>\r\n            <description><![CDATA[Ceci est ma deuxième actualité]]></description>\r\n            <pubDate>Sat, 07 Sep 2002 00:00:01 GMT</pubDate>\r\n            <link>http://www.example.org/actu2</link>\r\n        </item>\r\n    </channel>\r\n</rss>\r\n";
	var inputXml = Xml.parse(inputString);
	var cleanedXml = org.silex.core.XmlUtils.cleanUp(inputXml);
	utest.Assert.equals(inputXml.firstElement().getNodeName(),cleanedXml.getNodeName(),null,{ fileName : "XmlUtilsTests.hx", lineNumber : 67, className : "org.silex_unit_tests.core.XmlUtilsTests", methodName : "test_cleanUpXml_1"});
	utest.Assert.equals(inputXml.firstElement().get("a"),cleanedXml.get("a"),null,{ fileName : "XmlUtilsTests.hx", lineNumber : 68, className : "org.silex_unit_tests.core.XmlUtilsTests", methodName : "test_cleanUpXml_1"});
	utest.Assert.equals(inputXml.firstElement().firstElement().getNodeName(),cleanedXml.firstElement().getNodeName(),null,{ fileName : "XmlUtilsTests.hx", lineNumber : 69, className : "org.silex_unit_tests.core.XmlUtilsTests", methodName : "test_cleanUpXml_1"});
	utest.Assert.equals("rss",cleanedXml.getNodeName(),null,{ fileName : "XmlUtilsTests.hx", lineNumber : 71, className : "org.silex_unit_tests.core.XmlUtilsTests", methodName : "test_cleanUpXml_1"});
	utest.Assert.equals("b",cleanedXml.get("a"),null,{ fileName : "XmlUtilsTests.hx", lineNumber : 72, className : "org.silex_unit_tests.core.XmlUtilsTests", methodName : "test_cleanUpXml_1"});
	utest.Assert.equals("channel",cleanedXml.firstElement().getNodeName(),null,{ fileName : "XmlUtilsTests.hx", lineNumber : 73, className : "org.silex_unit_tests.core.XmlUtilsTests", methodName : "test_cleanUpXml_1"});
	$s.pop();
}
org.silex_unit_tests.core.XmlUtilsTests.prototype.test_cleanUpXml_2 = function() {
	$s.push("org.silex_unit_tests.core.XmlUtilsTests::test_cleanUpXml_2");
	var $spos = $s.length;
	var inputString = "";
	var inputXml = Xml.parse(inputString);
	var cleanedXml = org.silex.core.XmlUtils.cleanUp(inputXml);
	utest.Assert.same(inputXml,cleanedXml,null,null,{ fileName : "XmlUtilsTests.hx", lineNumber : 89, className : "org.silex_unit_tests.core.XmlUtilsTests", methodName : "test_cleanUpXml_2"});
	utest.Assert.equals(null,null,null,{ fileName : "XmlUtilsTests.hx", lineNumber : 92, className : "org.silex_unit_tests.core.XmlUtilsTests", methodName : "test_cleanUpXml_2"});
	$s.pop();
}
org.silex_unit_tests.core.XmlUtilsTests.prototype.__class__ = org.silex_unit_tests.core.XmlUtilsTests;
...
org.silex.core.XmlUtils.cleanUp = function(xml) {
	$s.push("org.silex.core.XmlUtils::cleanUp");
	var $spos = $s.length;
	var xmlCopy = Xml.parse(xml.toString()).firstElement();
	if(xmlCopy != null) {
		{
			var $tmp = org.silex.core.XmlUtils.cleanUpRecursive(xmlCopy);
			$s.pop();
			return $tmp;
		}
	}
...
org.silex.core.XmlUtils.cleanUpRecursive = function(xml) {
	$s.push("org.silex.core.XmlUtils::cleanUpRecursive");
	var $spos = $s.length;
...
org.silex.core.XmlUtils.stringIndent2Xml = function(xmlString) {
	$s.push("org.silex.core.XmlUtils::stringIndent2Xml");
	var $spos = $s.length;
	var xml = Xml.parse(xmlString);
	{
		var $tmp = org.silex.core.XmlUtils.cleanUp(xml);
		$s.pop();
		return $tmp;
	}
	$s.pop();
...
org.silex.core.XmlUtils.xml2StringIndent = function(xml) {
	$s.push("org.silex.core.XmlUtils::xml2StringIndent");
	var $spos = $s.length;
	var firstElement = xml.firstElement();
	{
		var $tmp = org.silex.core.XmlUtils.xml2StringIndentRecursive(firstElement,"");
		$s.pop();
		return $tmp;
	}
	$s.pop();
...
org.silex.core.XmlUtils.xml2StringIndentRecursive = function(xml,indentationLevel) {
	$s.push("org.silex.core.XmlUtils::xml2StringIndentRecursive");
	var $spos = $s.length;
...
org.silex_unit_tests.core.XmlUtilsTests.main()