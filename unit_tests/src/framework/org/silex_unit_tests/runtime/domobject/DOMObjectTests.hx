...
class DOMObjectTests 
{
	...
	{
		#if flash9
		var domObject:ContainerDOMObject = new ContainerDOMObject(new Sprite());
		#elseif js
		var domObject:ContainerDOMObject = new ContainerDOMObject(js.Lib.document.createElement("div"));
		#elseif php
		...
		Assert.same(domObject.getSemantic(), "nav");
	}
	...
	public function testTextDOMObject()
	{
		...
		#elseif js
		var domObject:TextDOMObject = new TextDOMObject(js.Lib.document.createElement("div"));
		#elseif php
		...
		Assert.same(domObject.getText(), "<h1>test html text</h1>");
	}
